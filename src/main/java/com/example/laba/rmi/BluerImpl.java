...
public class BluerImpl extends UnicastRemoteObject implements Bluer {
    public BluerImpl() throws RemoteException {
        super();
    }

    @Override
    public byte[] blurring(byte[] byteOfImage) throws RemoteException {
